...
const PVT_KEY = process.env.NEXT_PVT_KEY;
...
const networks = {
  ...
  // },
  localhost: {
    chainId: `0x${Number(1337).toString(16)}`, // Adjust to Besu's chain ID
    chainName: "Hyperledger Besu",
    nativeCurrency: {
      name: "ETH",
      symbol: "ETH",
      decimals: 18,
    },
    rpcUrls: ["http://127.0.0.1:8545"], // Adjust if using a different Besu RPC URL
    blockExplorerUrls: [], // Besu does not have a built-in explorer, but can integrate with Ethstats or custom solutions
  },
};
